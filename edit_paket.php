...
<?php
    ...
    if (isset($_POST['id_pw']) )
    {
        ...
        //{
            ...
            $client = new nusoap_client('http://satub.burhanudin.me/satub_3160/service/service_paket.php');
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <title>Edit Paket Wisata - Travel</title>
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                           <li class="new-ads"><a href="index.php" class="btn btn-ads btn-block">Home</a></li>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                   <ul class="author-menus">
                                        <li class="new-ads" ><a href="tambah_paket.php" class="btn btn-ads btn-block" style="color:white">Tambah Paket</a></li>
                                        <li><a href="tambah_promo.php">Tambah Promo</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
